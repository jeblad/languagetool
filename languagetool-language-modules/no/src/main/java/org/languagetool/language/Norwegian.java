...
public class Norwegian extends Language {
  ...
  */
  ...
  public Disambiguator getDisambiguator() {
    if (disambiguator == null) {
      disambiguator = new XmlRuleDisambiguator(new Norwegian());
    }
  ...
  */
  ...
  public Contributor[] getMaintainers() {
    return new Contributor[] {new Contributor("John Erling Blad") };
  }
  ...
  public List<Rule> getRelevantRules(ResourceBundle messages) {
    return Arrays.asList(
            ...
            new UppercaseSentenceStartRule(messages, this),  // abbreviation exceptions, done in NorwegianSentenceTokenizer
